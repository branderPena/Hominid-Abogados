...
class Database
{
    ...
    */
    private static function connect()
    {
        ...
        $server = 'localhost';
        $database = 'HomonidAbogados';
        $username = 'postgres';
        $password = 'Holamundo2m';
    ...
    */
    public static function executeRow($query, $value)
    {
        try {
            self::connect();
            self::$statement = self::$connection->prepare($query);
            $state = self::$statement->execute($value);
    ...
    */
    public static function getLastRow($query, $value)
    {
        try {
            self::connect();
            self::$statement = self::$connection->prepare($query);
            if (self::$statement->execute($value)) {
    ...
    */
    public static function getRows($query, $value)
    {
        try {
            self::connect();
            self::$statement = self::$connection->prepare($query);
