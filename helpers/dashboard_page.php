        ...
        print('
            ...
            <html lang="es">
                <head>
                    ...
                    <link type="image/png" rel="icon" href="../resources/image/Logo.png"/>
                        ...
                        <div class="navbar-fixed">
                            <nav class="brown">
                                <div class="nav-wrapper">
                                    <a href="main.php" class="brand-logo"><img src="../resources/image/Logo.png" height="60"></a>
                                    <a href="#" data-target="mobile" class="sidenav-trigger"><i class="material-icons">menu</i></a>
                                    <ul class="right hide-on-med-and-down">
                                        <li><a href="casos.php"><i class="material-icons left">folder</i>Mostrar Casos</a></li>
                                        <li><a href="abogados.php"><i class="material-icons left">contacts</i>Abogados</a></li>
                                        <li><a href="asignar_casos.php"><i class="material-icons left">create_new_folder</i>Asignar Casos</a></li>
                            ...
                            <li><a href="casos.php"><i class="material-icons left">folder</i>Mostrar Casos</a></li>
                            <li><a href="abogados.php"><i class="material-icons left">contacts</i>Abogados</a></li>
                            <li><a href="asignarcaso.php"><i class="material-icons left">create_new_folder</i>Asignar Casos</a></li>
                            <li><a href="usuarios.php"><i class="material-icons left">group</i>Usuarios</a></li>
                            <li><a href="#" class="dropdown-trigger" data-target="dropdown"><i class="material-icons left">verified_user</i>Cuenta: <b>' . $_SESSION['usuario'] . '</b></a></li>
                        </ul>
                        <ul id="dropdown-mobile" class="dropdown-content">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col s12 m6 l6">
                                    ...
                                    <a class="white-text" href="https://hominidabogados.com/" target="_blank"><i class="material-icons left">store</i>Sitio público</a>
                                </div>
                            </div>
                        </div>
                        <div class="footer-copyright">
                            <div class="container">
                                <span>© Hominid Abogados, todos los derechos reservados.</span>
                    ...
                    <form method="post" id="profile-form">
                        <div class="row">
                            ...
                            <div class="input-field col s12 m6">
                                ...
                                <input id="usuario_perfil" type="text" name="usuario_perfil" class="validate" required/>
