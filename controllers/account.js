        ...
        if (request.ok) {
            request.json().then(function (response) {
                ...
                if (response.status) {
                    ...
                    document.getElementById('nombres_perfil').value = response.dataset.nombres;
                    document.getElementById('apellidos_perfil').value = response.dataset.apellidos;
                    document.getElementById('usuario_perfil').value = response.dataset.usuario;
                    document.getElementById('correo_perfil').value = response.dataset.correo;
